...
public class AcheteurChocolatBourse extends AcheteurChocolatBourseAbs implements IAcheteurChocolatBourse {
	...
	public double getDemande(Chocolat chocolat, double cours) {
		...
		double max = solde/cours; // représente la quantité maximale en tonnes de chocolat achetable au prix du cours sans se mettre à découvert  
