...
import control.CtrlBtnFaillite;
...
public class FenetrePrincipale extends JFrame {
	...
	public FenetrePrincipale(String[] args) {
		...
		if (args.length==0) { // Filiere par defaut
			...
			IActeur[] equipes = { new Producteur1(), new Producteur2(), new Transformateur1(), new Transformateur2(), new Distributeur1(), new Distributeur2(), new Romu()};
			int i=0; 
