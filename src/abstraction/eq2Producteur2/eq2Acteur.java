...
public class eq2Acteur implements IActeur {
	...
	public void initialiser() {
		...
		this.getPaquetsArbres().add(new PaquetArbres(2500, Feve.FEVE_HAUTE, 48));
		this.getPaquetsArbres().add(new PaquetArbres(2110, Feve.FEVE_MOYENNE_EQUITABLE,70));
		this.getPaquetsArbres().add(new PaquetArbres(2500, Feve.FEVE_HAUTE_EQUITABLE,80));
