...
public final class ExemplaireContratCadre {
	...
	/**
	 * @return Retourne la liste des prix a la tonne. Le premier element est la proposition 
	 * initiale faite par le vendeur, le second la contreproposition faite par l'acheteur, ...
	 */
	public List<Double> getListePrixALaTonne() {
		return this.contratCadre.getListePrixALaTonne();
	}

	/**
	 * @return Retourne le prix a la tonne (la derniere valeur de la liste getListePrixALaTonne, les 
	 * premiere valeurs de cette liste n'etant que les etapes de negociations)
	 */
	public Double getPrixALaTonne() {
		return this.contratCadre.getPrixALaTonne();
	}
