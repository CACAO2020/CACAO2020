...
import abstraction.eq8Romu.cacaoCriee.ExempleAbsAcheteurCacaoCriee;
import abstraction.eq8Romu.produits.Feve;
import abstraction.fourni.Filiere;
import abstraction.fourni.Journal;

public class Eq4AcheteurCacaoCriee extends ExempleAbsAcheteurCacaoCriee  implements IAcheteurCacaoCriee {
	private Map<Feve, Double> prixCourant;

	public Eq4AcheteurCacaoCriee() {
		super();
	...
	public double proposerAchat(LotCacaoCriee lot) {
		double prix = this.prixCourant.get(lot.getFeve())*0.9; // on tente de payer un peu moins
